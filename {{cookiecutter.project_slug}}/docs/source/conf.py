...
def get_project_metadata():
    metadata_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "../..", '{{cookiecutter.project_slug}}', '__version__.py'))
    metadata = dict()
...
copyright = '{{ cookiecutter.year }}, {}'.format(metadata['__author__'])
...
latex_documents = [
    (master_doc, '{{ cookiecutter.project_slug }}.tex',  '{} Documentation'.format(metadata['__title__']),
...
texinfo_documents = [
    (master_doc, metadata['__title__'], '{} Documentation'.format(metadata['__title__']),
    metadata['__author__'], '{{ cookiecutter.project_slug }}', metadata['__description__'],
     'Miscellaneous'),
]
