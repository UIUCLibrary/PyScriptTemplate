...
project = {{ cookiecutter.project_slug }}.FULL_TITLE
copyright = '{{ cookiecutter.year }}, {}'.format({{ cookiecutter.project_slug }}.__author__)
...
texinfo_documents = [
    (master_doc, '{{ cookiecutter.project_slug }}', '{{ cookiecutter.project_name }} Documentation',
     author, '{{ cookiecutter.project_slug }}', 'One line description of {{ cookiecutter.project_name }}.',
     'Miscellaneous'),
]
